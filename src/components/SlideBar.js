    ...
    <div className="flex-none  bg-black h-screen min-w-[25%] fixed ">
      <div className="nav flex  text-white text-lg mt-10 flex-col align-middle justify-center text-center w-full gap-5 overflow-hidden">
        <div data-aos="slide-down">
          ...
          />
          <h3 className="text-white name py-4 font-medium ">Rajkumar Patel</h3>
        </div>
        <p
          onClick={() => setSelect(0)}
      ...
      >
        <div
          onClick={() => window.open("https://github.com/rkpatel94", "_blank")}
        >
          <GitHubIcon className="cursor-pointer hover:scale-105" />
        </div>
        <div
          onClick={() =>
            window.open("https://www.instagram.com/rk_patel0112", "_blank")
          }
        >
          {" "}
        ...
        <div
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/rajkumar-patel-34a72b186",
              "_blank"
            )
          }
        >
